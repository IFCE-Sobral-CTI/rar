            ...
            >
                ...
                <Panel className={'flex flex-wrap items-center justify-center gap-1 md:gap-4'}>
                    ...
                    {(!!report.file) &&
                        <>
                            <a
                                href={route('reports.pdf', { report: report.id })}
                            ...
                            <a
                                href={route('reports.html', { report: report.id })}
                                className='inline-flex gap-2 items-center px-4 py-2 border border-transparent tracking-widest text-sm rounded-lg text-white transition ease-in-out duration-150 focus:ring-2 bg-cyan-500 hover:bg-cyan-600 focus:ring-cyan-300 '
                                target='_blank'
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 16 16" className="h-5 w-5">
                                    <path fill="currentColor" fillRule="evenodd" d="M14 4.5V11h-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5L14 4.5Zm-9.736 7.35v3.999h-.791v-1.714H1.79v1.714H1V11.85h.791v1.626h1.682V11.85h.79Zm2.251.662v3.337h-.794v-3.337H4.588v-.662h3.064v.662H6.515Zm2.176 3.337v-2.66h.038l.952 2.159h.516l.946-2.16h.038v2.661h.715V11.85h-.8l-1.14 2.596H9.93L8.79 11.85h-.805v3.999h.706Zm4.71-.674h1.696v.674H12.61V11.85h.79v3.325Z"/>
                                </svg>
                                <span>HTML</span>
                            </a>
                        </>
