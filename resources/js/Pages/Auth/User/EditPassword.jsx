                ...
                <Panel>
                    <form onSubmit={handleSubmit} autoComplete="off">
                        <div className="mb-4">
                            ...
                            <Input type={'password'} value={data.password} name={'password'} handleChange={onHandleChange} required={true} placeholder="Digite a nova senha" />
                            <InputError message={errors.password} />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="password_confirmation" className="font-light">Confirmação de senha</label>
                            <Input type={'password'} value={data.password_confirmation} name={'password_confirmation'} handleChange={onHandleChange} required={true} placeholder="Digite a confirmação da nova senha" />
