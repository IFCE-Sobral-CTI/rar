                ...
                <div className="flex flex-col w-48 gap-3 md:w-64">
                    ...
                    {(can.students_viewAny || can.courses_viewAny || can.weekdays_viewAny || can.semesters_viewAny || can.course_types_viewAny) && <>
                        ...
                        >
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512" className="h-5 w-5">
                                    <path fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="32" d="M48 336v96a48.14 48.14 0 0 0 48 48h320a48.14 48.14 0 0 0 48-48v-96"/>
                                    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M48 336h144m128 0h144m-272 0a64 64 0 0 0 128 0"/>
                                    <path fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="32" d="M384 32H128c-26 0-43 14-48 40L48 192v96a48.14 48.14 0 0 0 48 48h320a48.14 48.14 0 0 0 48-48v-96L432 72c-5-27-23-40-48-40Z"/>
                                    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M48 192h144m128 0h144m-272 0a64 64 0 0 0 128 0"/>
                                </svg>
                                Tipos de Cursos
                            </Link>}
